...
export const casosExito: CasoExito[] = [
  ...
  {
    servicio: "Reparación de tuberías HDPE",
    titulo: "Caso referencial de tubería HDPE con fuga o pérdida de estanqueidad",
    problema: "Un tramo HDPE evidencia fuga, deformación o unión comprometida que afecta continuidad de agua potable o aguas servidas.",
    procedimiento: "Se revisa condición del tramo, diámetro, presión y factibilidad de reparación con verificación posterior.",
    resultado: "La red queda con intervención controlada y recomendaciones para prevenir falla recurrente.",
    recomendacion: "Evitar reparaciones improvisadas cuando la tubería soporta presión, carga o continuidad crítica.",
    ctaLabel: "Consultar reparación",
    ctaHref: casoWhatsApp("reparación de tuberías HDPE"),
  },
  {
